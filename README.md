...
- **Multilingual Support**: JSON-based localization files in the `lang/` directory.
- **SEO Optimized**: Includes metadata, structured data, and a sitemap.
- **Offline Support**: Service worker for caching and offline access.
- **Reusable Components**: Modular HTML and JavaScript in the `partials/` directory.
